...
[_QWERTY] = {
  ...
  {M_FUNC, KC_LCTL, KC_LALT, KC_LGUI, M_LOWER,   KC_BKFN,  KC_SPFN,  M_RAISE,   KC_RGUI, KC_RALT, KC_RCTL, HYPER}
},
...
[_GAM3R] = {
  ...
  {CTLESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT},
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ENTSFT },
  {M_GAMEUP,  KC_LCTL, KC_LALT, KC_LGUI, M_LOWER,  KC_SPC, KC_SPC,   M_RAISE,   KC_RGUI, KC_RALT, KC_RCTL,  FUNC}
},
